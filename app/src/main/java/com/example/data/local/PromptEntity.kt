...
data class AppAdminSettingsEntity(
  ...
  val adminPin: String = "0644782611",
  val announcementEnabled: Boolean = false,
  val announcementText: String = "",
  val primarySiteUrl: String = "https://prmtly.com",
  val supportEmail: String = "support@prmtly.com",
  val backendApiUrl: String = "https://lightseagreen-sheep-814894.hostingersite.com/api/sync.php",
  val backendApiKey: String = "promptly_secret_key_2026",
